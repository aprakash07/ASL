...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Give Sign Input here: ")
        ...
        self.T.config(text = "Give Sign Input Here: ", font = ("Courier", 30, "bold"))
    ...
    def predict(self, test_image):
        ...
        if(self.current_symbol == 'M' or self.current_symbol == 'N' or self.current_symbol == 'S'):
            ...
            prediction1['M'] = result_tkdi[0][0]
            prediction1['N'] = result_tkdi[0][1]
            prediction1['S'] = result_tkdi[0][2]

            prediction1 = sorted(prediction.items(), key = operator.itemgetter(1), reverse = True)
